"""Module with apex class for solving photogrammetry geometry from apex targets
   This is a special one to use THREE reference targets!
...
def compute_the_residuals(v,data,ref):
    ...
    k = 0
    for i in range(3):   # NOTE FOR THREE POINTS!
...
class apex3():
    ...
    def __init__(self,
        ...
        self.nref = 3
        # special reference targets
        self.apex_pt = np.array([
#                [1530.7097,       2.2873077,       209.90184],    # pt1
                [-6.7262022,      -1497.4317,       191.83527],    # pt2
                [-1503.8713,       231.35098,       191.87650],    # pt3
                [-2.1873739,       1529.4748,       200.89445]     # pt4 
                ])   
#        self.apex_pt = np.array([
...
#                [-1024.4449,1109.39855,223.30923]])
    ...
    def print_csv_dimension_line(self,id):
        z = self.reference_dimensions-self.data_dimensions
        print('%s,%f,%f,%f'%(id,z[0,1],z[0,2],z[1,2]))
        print(' ')

    def write_csv_dimension_line(self,f,id):
        z = self.reference_dimensions-self.data_dimensions
        f.write('%s,%f,%f,%f\n'%(id,z[0,1],z[0,2],z[1,2]))
